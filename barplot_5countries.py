...
negative_bar = (len(Omited_Code_Malaysia.negativeFound),len(Omited_Code_Canada.negativeFound),len(Omited_Code_Japan.negativeFound),len(Omited_Code_Singapore.negativeFound),len(Omited_Code_Qatar.negativeFound))
neutral_bar = (len(Omited_Code_Malaysia.neutralFound),len(Omited_Code_Canada.neutralFound),len(Omited_Code_Japan.neutralFound),len(Omited_Code_Singapore.neutralFound),len(Omited_Code_Qatar.neutralFound))

...
fig = px.bar(x=["positive", "positive", "stop"], y=[len(positivewords), len(positivewords), stopcount],
             title="Singapore wordcount")
fig.write_html('sing_hist.html', auto_open=True)
